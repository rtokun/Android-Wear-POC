...
import com.artyom.androidwearpoc.dagger.modules.CrashReportModule;
 ...
 */
@ForApplication
@Component(modules = {NotificationModule.class, CrashReportModule.class, SharedPrefsModule.class})
